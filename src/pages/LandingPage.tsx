...
export default function LandingPage() {
    return (
        <div id="landing-page">
            <section className="relative min-h-[100vh] flex gap-20 items-center justify-center px-[10%] overflow-x-clip overflow-y-visible">
                <div className="flex-1 flex flex-col gap-8">
                    ...
                    <div className="flex items-center gap-6 mt-6">
                        ...
                        <button className="group relative h-[60px] min-w-[200px] text-white rounded-full flex items-center justify-center gap-3 px-8 before:absolute before:top-0 before:left-0 before:w-full before:h-full before:rounded-full before:bg-black before:transition-transform hover:before:scale-110">
            ...
            <div className="bg-black mt-[10%] pb-[10%] -mb-20 relative min-h-[100vh] overflow-x-clip overflow-y-visible">
                <section className="relative z-[1] translate-y-[-50%] flex items-center">
                    ...
                    <ul className=" flex-1 w-[60%] flex gap-6 justify-evenly p-[5%] bg-[#efefef] rounded-full">
                        <li className="flex flex-1 flex-col text-center gap-4">
                ...
                <section className="relative flex flex-col gap-20 items-center justify-center p-[10%] pt-0 text-white">
                    ...
                    <div className="flex w-full justify-between items-center gap-4 relative">
                        <h2 className="text-4xl font-semibold">Unlock the power of AI with MongoDB</h2>
            ...
            <section className="bg-black text-white flex flex-col items-center justify-center gap-20 p-[10%]">
                ...
                <section className="p-[5%] relative rounded-[100px] rounded-tl-none bg-[#efefef] flex flex-col gap-20 overflow-clip">
                    ...
                    <div className="relative flex justify-between gap-10">
                        <div className="flex flex-col">
                            ...
                            <h3 className="text-3xl font-semibold text-gray-400">Check out what you'll be getting in on.</h3>
                        </div>
                        <button className="group relative flex items-center justify-center gap-4 px-8 hover:text-blue-600">
