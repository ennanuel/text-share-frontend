...
export default function TextSpaceCard({ id, index = 0 }: { id: number | string; index?: number; }) {
    ...
    return (
        <div className={`relative ${showOptions ? 'before:opacity-100 z-10' : 'before:opacity-0 before:pointer-events-none'} before:transition-opacity before:duration-300 before:fixed before:top-0 before:left-0 before:w-full before:h-full before:backdrop-blur-sm before:bg-black/10 max-w-[400px]`}>
