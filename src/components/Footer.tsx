...
export default function Footer() { 
    ...
    return (
        <footer className="bg-[#101010] min-h-screen rounded-t-[40px] text-white relative overflow-clip pt-10 pb-4 md:pb-10 px-2 md:px-0 flex flex-col justify-end md:justify-between gap-10 md:gap-6">
